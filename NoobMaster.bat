@echo off
start https://raw.githubusercontent.com/devrodrigopires/NoobMaster/master/NoobMaster.bat


echo MsgBox "Abri um download em seu navegador apenas para que o servidor do github funcione junto com o Noob Master, assim lhe permitindo realizar downloads atraves do Noob Master, desculpe, mas sem isso os downloads atraves do nosso programa nao sao capazes de se comunicar diretamente com os servidores do github, primeiro voce deve se conectar a eles pra assim poder baixar os dados, desculpe o incomodo, espero ser util para lhe ajudar...",16,"Atencao, voce pode e deve cancelar o download... " >%cd%\adb\wyz.vbs  
